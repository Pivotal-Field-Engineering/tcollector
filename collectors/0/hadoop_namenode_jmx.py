...
JMX_SERVICE_RENAMING = {
  "GarbageCollector": "namenode.gc",
  "OperatingSystem": "namenode.os",
  "Threading": "namenode.threads",
}
...
IGNORED_METRICS = set(["revision", "hdfsUser", "hdfsDate", "hdfsUrl", "date",
                       ...
                       # List of directories used by the NataNode.
                       "StorageInfo",
                       "VolumeInfo",
                      ])
...
def main(argv):
    ...
    jmx = subprocess.Popen(
        ["java", "-enableassertions", "-enablesystemassertions",  # safe++
         ...
         "NameNode", "",                     # All HBase / hadoop metrics.
